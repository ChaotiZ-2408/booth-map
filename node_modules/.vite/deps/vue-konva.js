import { Bt as onUpdated, Ft as onMounted, Kn as ref, U as computed, Wn as reactive, er as toValue, gn as watch, jt as onBeforeUnmount, nt as defineComponent, pt as h, ut as getCurrentInstance, zt as onUnmounted } from "./vue.runtime.esm-bundler-C6sZGmPl.js";
...
var Image$1 = class Image$1 extends Shape {
	constructor(attrs) {
		super(attrs);
		this._loadListener = () => {
			this._requestDraw();
...
//#endregion
//#region node_modules/vue-konva/dist/vue-konva.mjs
function y(o) {
...
function M(o, n, c, a) {
	...
	let r = !1;
	for (let t in c) {
		if (T.hasOwnProperty(t)) continue;
...
var P = ".vue-konva-vmodel", b = "onUpdate:";
function _(o, n) {
	o.off(P);
	const c = n.vnode.props || {};
	for (const a in c) if (a.startsWith(b)) {
		const e = a.slice(9), l = c[a];
		o.on(`${e}Change${P}`, () => {
			l(o.getAttr(e));
		});
	}
...
function W(o) {
	...
	if (n?.tagName && c && !a) {
		...
		return console.error(`vue-konva error: You are trying to render "${e}" inside your component tree. Looks like it is not a Konva node. You can render only Konva components inside the Stage.`), null;
	}
	return a;
}
function B(o) {
...
var D = lib_default.default?.Stage || lib_default.Stage, Y = defineComponent({
	name: "Stage",
	props: {
		config: {
			type: Object,
	...
	return defineComponent({
		...
		setup(c, { attrs: a, slots: e, expose: l }) {
			...
			function g() {
				if (!r) return;
				const v = {};
				for (const h in r?.vnode.props) h.slice(0, 2) === "on" && (v[h] = r.vnode.props[h]);
				const K = t || {}, E = {
					...a,
					...c.config,
					...v
...
var u = lib_default.default || lib_default, X = i("Arc", u.Arc), q = i("Arrow", u.Arrow), H = i("Circle", u.Circle), J = i("Ellipse", u.Ellipse), Q = i("FastLayer", u.FastLayer), ee = i("Group", u.Group), ne = i("Image", u.Image), te = i("Label", u.Label), oe = i("Layer", u.Layer), re = i("Line", u.Line), ce = i("Path", u.Path), ae = i("Rect", u.Rect), se = i("RegularPolygon", u.RegularPolygon), ie = i("Ring", u.Ring), ue = i("Shape", u.Shape), le = i("Sprite", u.Sprite), de = i("Star", u.Star), fe = i("Tag", u.Tag), ge = i("Text", u.Text), ve = i("TextPath", u.TextPath), pe = i("Transformer", u.Transformer), me = i("Wedge", u.Wedge), ye = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	__proto__: null,
	Arc: X,
	Arrow: q,
	Circle: H,
	...
	Transformer: pe,
	Wedge: me
}, Symbol.toStringTag, { value: "Module" })), Se = { install: (o, n) => {
	const c = n?.prefix || F, a = n?.customNodes ? Object.entries(n.customNodes).map(([l, r]) => i(l, r)) : [];
	[
		Y,
		...Object.values(ye),
		...a
...
//#endregion
export { X as Arc, q as Arrow, H as Circle, J as Ellipse, Q as FastLayer, ee as Group, ne as Image, te as Label, oe as Layer, re as Line, ce as Path, ae as Rect, se as RegularPolygon, ie as Ring, ue as Shape, le as Sprite, Y as Stage, de as Star, fe as Tag, ge as Text, ve as TextPath, pe as Transformer, me as Wedge, Se as default, Ne as useImage };
