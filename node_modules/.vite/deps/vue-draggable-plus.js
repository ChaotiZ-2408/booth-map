import { $n as toRefs, Fn as isProxy, Ft as onMounted, Kn as ref, Ot as nextTick, Rn as isRef, U as computed, Wn as reactive, gn as watch, nr as unref, nt as defineComponent, pt as h$1, ut as getCurrentInstance, zt as onUnmounted } from "./vue.runtime.esm-bundler-C6sZGmPl.js";
//#region node_modules/vue-draggable-plus/dist/vue-draggable-plus.js
...
var ft = [
	...
	[Bt.mounted](t, e) {
		const [o, r] = isProxy(e.value) ? [e.value] : e.value, i = on(t, o, r);
		at.set(t, i.destroy);
	},
	[Bt.unmounted](t) {
		var e;
...
//#endregion
export { lo as VueDraggable, on as useDraggable, so as vDraggable };
